      ...
      >
          ...
          <View style={styles.sectionCard}>
            ...
            <View style={styles.orientationBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  console.log("[Mother Dashboard] User pressed Ver todas orientações");
                  router.push("/(tabs)/(home)/mother-orientations");
                }}
              >
        ...
        <View style={styles.actionsSection}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              console.log("[Mother Dashboard] User pressed Registrar Rotina button");
              if (hasActiveContract) {
                router.push("/(tabs)/(home)/mother-day-selection");
              }
            }}
          ...
          <View style={styles.secondaryActions}>
            <TouchableOpacity
              ...
              onPress={() => {
                console.log("[Mother Dashboard] User pressed Orientações button");
                router.push("/(tabs)/(home)/mother-orientations");
              }}
            >
              <IconSymbol
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                console.log("[Mother Dashboard] User pressed Evolução button");
                if (hasActiveContract) {
                  router.push("/(tabs)/(home)/mother-evolution");
                }
              }}
              disabled={!hasActiveContract}
            >
