              ...
              >
                <View style={styles.routineCardHeader}>
                  <View>
                    ...
                    <Text style={styles.routineDayNumber}>Dia {dayNumber} – {routineStatus}</Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  quickActions: { flexDirection: "row", gap: 12Vou adicionar o dia da semana acima da data na lista de rotinas da consultora!
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={styles.infoCard}>
          ...
          <TouchableOpacity style={styles.addButton} onPress={loadReport}>
            <Text style={styles.Vou adicionar o dia da semana acima da data na lista de rotinas da consultora!
...
const styles = StyleSheet.create({
  ...
  routineDayNumber: { fontSize: 16, fontWeight: "600", color: colors.text, marginTop: 2 },
  routineDate: { fontSize: 13, color: colors.textSecondary, marginTop: 2 },
